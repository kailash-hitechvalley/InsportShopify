...
class OrderController extends Controller
{
    ...
    public function getOrders(Request $request)
    {
        ...
        if ($orderId) {
            ...
            $query = $this->getOrdersQuery($this->clientCode, $this->live);
        }
        ...
        if (!empty($res->data->orders->edges)) {
            ...
            try {
                foreach ($res->data->orders->edges as $orderEdge) {
                    ...
                    Log::info('Customer details:', (array) $customerDetails);
        ...
        if (!empty($datas->data->orders->edges)) {
            ...
            try {
                ...
                foreach ($datas->data->orders->edges as $edge) {
                    ...
                    $this->processShopifyRefund($order, $sourceRefund, $orderLineProducts, $orderLineProductsPrice, $orderLineProductsQty, $orderLineProductsID, $shopifyRefundId, $updateAt, $debug, $totalProductPrice, @$order->refunds[0], $cursor);
                    // }
                }
    ...
    private function processShopifyRefund($order, $sourceRefund, $refundProducts, $refundPrices, $refundQty, $orderLineProductsID, $shopifyRefundId, $updateAt, $debug, $totalProductPrice, $refund, $cursor)
    {
